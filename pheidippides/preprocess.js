...
function preprocessHTML(inputHTML) {
  ...
  modifiedHTML = modifiedHTML
    ...
    modifiedHTML = modifiedHTML.replace(/<button\s+style="(.*?)"\s+class="(.*?)"\s+href="(.*?)">(.*?)<\/button>/g, '<table border="0" cellspacing="0" cellpadding="0" role="presentation" class="$2" style="width: auto; height: auto;cursor:pointer;"><tr><td><a href="$3" target="_blank" class="$2" style="display: inline-block;padding: 0;text-decoration: none;color: inherit; font-size: inherit;$1">$4</a></td></tr></table>');
